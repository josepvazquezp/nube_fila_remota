                ...
                if (this.selectedFile == null) {
                        ...
                        this.productService.changeImage(formData, id).subscribe((response: any) => {
                                if (this.productForm.value.name == '' && this.productForm.value.description == '' &&
                                        this.productForm.value.price == '' && this.productForm.value.available == '1' &&
                                        this.selectedFile != null) {
                                        body = { Image: enviroment.bucket + response.image };
                                }
                                else if (this.productForm.value.name != '' && this.productForm.value.description == '' &&
                                        this.productForm.value.price == '' && this.productForm.value.available == '1' &&
                                        this.selectedFile != null) {
                                        body = { Name: this.productForm.value.name, Image: enviroment.bucket + response.image };
                                }
                                else if (this.productForm.value.name == '' && this.productForm.value.description != '' &&
                                        this.productForm.value.price == '' && this.productForm.value.available == '1' &&
                                        this.selectedFile != null) {
                                        body = { Description: this.productForm.value.description, Image: enviroment.bucket + response.image };
                                }
                                else if (this.productForm.value.name == '' && this.productForm.value.description == '' &&
                                        this.productForm.value.price != '' && this.productForm.value.available == '1' &&
                                        this.selectedFile != null) {
                                        body = { Price: this.productForm.value.price, Image: enviroment.bucket + response.image };
                                }
                                else if (this.productForm.value.name == '' && this.productForm.value.description == '' &&
                                        this.productForm.value.price == '' && this.productForm.value.available != '1' &&
                                        this.selectedFile != null) {
                                        body = { Available: false, Image: enviroment.bucket + response.image };
                                }
                                else if (this.productForm.value.name != '' && this.productForm.value.description != '' &&
                                        this.productForm.value.price == '' && this.productForm.value.available == '1' &&
                                        this.selectedFile != null) {
                                        body = {
                                                Name: this.productForm.value.name,
                                                Description: this.productForm.value.description,
                                                Image: enviroment.bucket + response.image
                                        };
                                }
                                else if (this.productForm.value.name != '' && this.productForm.value.description == '' &&
                                        this.productForm.value.price != '' && this.productForm.value.available == '1' &&
